...
(function(global, factory) {
    ...
    moment.defineLocale('bm', {
        ...
        weekdays: 'Kari_Ntɛnɛn_Tarata_Araba_numairisa_Juma_Sibiri'.split('_'),
    ...
    moment.defineLocale('id', {
        ...
        meridiemParse: /pagi|siang|sore|mnumair/,
        meridiemHour: function(hour, meridiem) {
            if (hour === 12) {
                hour = 0;
            }
            ...
            } else if (meridiem === 'sore' || meridiem === 'mnumair') {
                return hour + 12;
            }
        },
        meridiem: function(hours, minutes, isLower) {
    ...
    moment.defineLocale('ms-my', {
        ...
        meridiemParse: /pagi|tengahari|petang|mnumair/,
        meridiemHour: function(hour, meridiem) {
            if (hour === 12) {
                hour = 0;
            }
            if (meridiem === 'pagi') {
                ...
                return hour >= 11 ? hour : hour + 12;
            } else if (meridiem === 'petang' || meridiem === 'mnumair') {
                return hour + 12;
            }
        },
        meridiem: function(hours, minutes, isLower) {
