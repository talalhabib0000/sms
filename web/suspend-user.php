  ...
  ?>
    ...
    <section class="content">
      ...
      $conn = new mysqli($DB_SERVER,$DB_USER,$DB_PASSWORD,$DB_NAME);
        ...
        //query
       $sql='SELECT id,fullname,email,status FROM users';
        ...
        while ($stmt->fetch()) {
          ...
          echo "<tr>";
            ...
            echo "<td>$name</td>";
             echo "<td>$email</td>";
             echo "<td>$status</td>";
             echo "<td><form action='users-status.php' method='post' class='my-form'><div><input type='hidden' value='$id' name='id'/>
              <input type='hidden' value='$status' name='status'/> <input type='submit' value='Switch Status'/></div></form></td>";
